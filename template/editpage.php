      ...
      <div class="flex-fill">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <form class="card" method="POST" action="/api/books/<?=$book["id"]?>/edit/">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                          <label class="form-label">Автор</label>
                          <input type="text" name="author" class="form-control" placeholder="Автор" value="<?=$book["author"]?>">
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                          <label class="form-label">Год</label>
                          <input type="text" name="year" class="form-control" data-mask="0000" data-mask-clearifnotmatch="true" placeholder="0000" value="<?=$book["year"]?>"/>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
