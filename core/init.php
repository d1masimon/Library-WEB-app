...
class App implements \ArrayAccess {
    ...
    */
    public function __construct ($settings = []) {
        ...
        $this->registry = array_merge([
            'debug'        => true,
            'app.name'     => 'eFrame',
            'session.name' => 'efappsession',
            'autoload'     => new \ArrayObject([]),
            'sec-key'      => 'xxxxx-SiteSecKeyPleaseChangeMe-xxxxx',
            'route'        => $_SERVER['PATH_INFO'] ? $_SERVER['PATH_INFO'] : '/',
            'charset'      => 'UTF-8',
            'helpers'      => [],
            'base_url'     => $base_url,
            'base_route'   => $base_url,
            'base_host'    => $_SERVER['SERVER_NAME'] ? $_SERVER['SERVER_NAME'] : php_uname('n'),
            'base_port'    => $_SERVER['SERVER_PORT'] ? $_SERVER['SERVER_PORT'] : 80,
            'docs_root'    => null,
            'site_url'     => null
        ], $settings);
        ...
        // default helpers
        $this->helpers = new \ArrayObject(array_merge(['session' => 'eFrame\\Session', 'cache' => 'eFrame\\Cache'], $this->registry["helpers"]));
    ...
    */
    ...
    public function paths($namespace = null) {
        ...
        return $this->paths[$namespace] ? $this->paths[$namespace] : [];
    }
    ...
    */
    ...
    public function loadModules($dirs, $autoload = true, $prefix = false) {
        ...
        $modules  = [];
        $dirs     = (array)$dirs;
        $disabled = $this->registry['modules.disabled'] ? $this->registry['modules.disabled'] : null;
