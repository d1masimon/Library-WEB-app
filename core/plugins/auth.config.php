...
class Config
{
    ...
    protected function setForgottenDictionary()
    {
        ...
        $lang['user_blocked'] = "Вы заблокированы";
        ...
        //new
        $lang['account_password_invalid'] = "Неверный пароль";

        //new
        $lang['account_not_found']          = "Аккаунт с данной почтой не найден";


        $lang['login_remember_me_invalid'] = "The remember me field is invalid.";

        $lang['email_password_invalid'] = "Неверная почта или пароль";
        $lang['email_password_incorrect'] = "Неверный пароль";
